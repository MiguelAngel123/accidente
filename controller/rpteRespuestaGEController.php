...
/**
 * rpteRespuestaGEController.php Controller
 *
 * @package
...
class rpteRespuestaGEController Extends baseController {
    ...
    function index() {
        ...
        $this->menu = new menu();
        $liMenu = $this->menu->imprimirMenu("rpteRespuestaGE", $_SESSION['USU_ID']);
        $this->registry->template->men_titulo = $liMenu;
        $this->registry->template->show('headerF');
        $this->registry->template->show('rpteRespuestaGE.tpl');
