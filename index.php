...
define("PATH_DOMAIN", "http://localhost/accidente");
define("PATH_ROOT", $_SERVER ['DOCUMENT_ROOT'] . "/accidente");
define("PATH_WEB", "http://localhost/accidente/web");

// Solamente se usa para servidores FTP
...
define('PGPORT', 5432);
define('PGDATABASE', 'bd_accidente');
define('PGUSER', 'accidente');
